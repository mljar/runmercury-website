      ...
      <div className="features-container bg-pink-100 dark:bg-black" style={{ padding: "30px", borderRadius: "30px" }}>
        ...
        <div className="content-container">
          ...
          <Features>
            ...
            <Feature index={0} centered className="card-with-border" href="/docs/show-hide-code-notebook/" aria="How to hide or show code in web app from Jupyter Notebook">
            ...
            <Feature index={1} centered className="card-with-border" href="/docs/export-pdf-html/" aria="Learn how to export Jupyter Notebook as PDF or HTML">
              <div className="h-full flex flex-col justify-between">
            ...
            <Feature index={2} centered className="card-with-border" href="/docs/authentication/" aria="Read more on how to add authentication to your Python notebooks">
              <div className="h-full flex flex-col justify-between">
            ...
            <Feature index={3} centered className="card-with-border" href="/docs/multiple-notebooks/" aria="Learn more on how to share multiple Python notebooks">
              <div className="h-full flex flex-col justify-between">
            ...
            <Feature index={4} centered className="card-with-border" href="/docs/jupyter-notebook-embedding/" aria="Read more on how to embed Python notebook in any website">
              <div className="h-full flex flex-col justify-between">
            ...
            <Feature index={5} centered className="card-with-border" href="/docs/output-files/" aria="Read more on how to make files from Python notebook downloadable">
              <div className="h-full flex flex-col justify-between">
