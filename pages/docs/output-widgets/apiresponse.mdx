...
description: Jupyter notebook can be executed with REST API and it returns JSON as response. This page describe how to use APIResponse class to return JSON from Python notebook, so you can use notebooks as REST API.
ogImage: widgets
---
