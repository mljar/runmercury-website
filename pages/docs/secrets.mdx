...
import examplePng from "../../public/images/secrets-management/example-use-database.png";
...
<Screenshot src={examplePng} alt="Using secrets to connect with database." />

- installing packages from private repositories using `requirements.txt`

You can get more information about it in [**Install your packages**](/docs/pip-install-requirements) doc. 