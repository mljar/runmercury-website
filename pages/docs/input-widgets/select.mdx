---
ogTitle: Select widget for Jupyter Notebook
description: Add Select widget to your Python notebook. Allow users to choose value from Select widget.
ogImage: widgets
---
...
First step is importing Mercury. Then create variable *(my_selection in our case)* and asign the `Select` widget to it. At the end print your results using `my_selection.value`.
