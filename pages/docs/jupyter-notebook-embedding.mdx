...
#### Embedded notebook
<iframe src="https://use-cases.runmercury.com/app/static-notebook-2/embed" height="700px" width="100%" style={{border: "1px solid #ccc", padding: "0px", borderRadius: "10px"}}></iframe>