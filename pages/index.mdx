...
<div className="lg:grid lg:grid-cols-2 lg:gap-4">
    <div>
      ...
      <div>
          <div style={{padding: "65px"}} className='sm:block hidden'/>
          ...
          <a href="https://github.com/mljar/mercury" className="font-medium text-xl m-5" target="_blank">Star on GitHub </a>
    </div>
</div>
...
<center>
    <h2 className=" lg:text-6xl text-4xl font-extrabold text-gray-900 dark:text-white leading-normal">Create with <img src="/images/mercury-black-logo.svg" style={{height: "96px"}} className="inline dark:hidden"></img><img src="/images/mercury-white-logo.svg" style={{height: "96px"}} className="hidden dark:inline"></img></h2>
    <p className="my-4 mb-8 font-light text-gray-500 text-2xl dark:text-gray-400 
    leading-normal" style={{paddingBottom: "50px", paddingTop: "20px", margin: "0px"}}>  You don't need to know frontend frameworks, 
    <strike>HTML, CSS or JavaScript</strike>. <br className='sm:block hidden'/>
All in pure <u className="font-extrabold">Python</u> without leaving Jupyter Notebook. </p>
    </center>
</div>
...
<div className="">
    <center>
    <h2 className=" lg:text-6xl text-4xl font-extrabold text-gray-900 dark:text-white leading-normal">You can build</h2>
    </center>
</div>
...
<div className="sm:block hidden" style={{width: "100%", background: "#f4dbda", position: "absolute",
 left: "0",
 right: "0",
 padding: "100px"
}}>
<center>
    <h2 className=" lg:text-6xl text-4xl font-extrabold text-gray-900 dark:text-white leading-normal">How does it work? </h2>
</center>
</div>
...
<div className="lg:grid lg:grid-cols-2 lg:gap-4">
      ...
      <div className="text-left">
          <div style={{padding: "30px"}} className='sm:block hidden'/>
...
<div className="lg:grid lg:grid-cols-2 lg:gap-4">
      ...
      <p className="my-8 mb-2 font-light text-gray-500 text-2xl dark:text-gray-400 
      ...
      <a href="/docs/output-widgets/"
             className="my-4 mx-4 text-white bg-primary-600 hover:bg-primary-700 
                        focus:ring-4 focus:ring-primary-200 font-medium rounded-lg 
                        text-xl px-5 py-2.5 text-center dark:text-white  dark:focus:ring-primary-900">Output Widgets</a>

    </div>
    <div>
      <div style={{padding: "40px"}} className='sm:block hidden'/>
...
<div className="lg:grid lg:grid-cols-2 lg:gap-4">
    ...
    <div>
      <div style={{padding: "0px"}} className='sm:block hidden'/>
      <Image src={mercuryAppPng} alt="Add widgets" loading="eager" 
            style={{margin: "0px", maxHeight: "500px", width: "auto", margin: "auto" }} />
    </div>
</div>
...
<div className="">
    <center>
    <h2 className=" lg:text-6xl text-4xl font-extrabold text-gray-900 dark:text-white leading-normal">Amazing features</h2>
    </center>
</div>
...
<div className="features-container" style={{background: "#f4dbda", padding: "30px", borderRadius: "30px"}}>
      ...
      <Features>
        ...
        <Feature index={1}  centered className="card-with-border" href="/docs/export-pdf-html/">
          <div className="h-full flex flex-col justify-between">
            ...
            <h3 style={{marginTop: "20px"}}>Export to PDF / HTML</h3>
            <p className="text-left mb-8 subtitle subtitle2" style={{marginTop: "10px"}}>
        ...
        <Feature index={2}  centered className="card-with-border" href="/docs/authentication/">
          <div className="h-full flex flex-col justify-between">
            ...
            <h3 style={{marginTop: "20px"}}>Built-in Authentication</h3>
            <p className="text-left mb-8 subtitle subtitle2" style={{marginTop: "10px"}}>
  ...
  <div className="content-container">
    <center>
    <h2 className="headline">Yes, it is open-source!</h2>
