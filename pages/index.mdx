...
<div className="">
  <center>
    <h2 className="my-4 lg:text-6xl text-4xl font-extrabold text-gray-900 dark:text-white leading-normal">
      You can build
    </h2>
  </center>
</div>
  ...
  >
    ...
    >
     ...
     <h2 className="my-4 lg:text-4xl text-2xl font-extrabold text-gray-900 leading-normal"> Mercury Cloud</h2>
          <p className="my-4 mb-8 font-light text-gray-500 text-2xl 
          leading-normal"> Upload</p>
  ...
  >
    ...
    >
     ...
     <h2 className="my-4 lg:text-4xl text-2xl font-extrabold text-gray-900 leading-normal"> Self host</h2>
          <p className="my-4 mb-8 font-light text-gray-500 text-2xl 
          leading-normal">    private forks.</p>
