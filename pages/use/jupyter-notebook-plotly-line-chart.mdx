...
- [**Plotly Histogram Chart**](https://github.com/mljar/mercury-integrations/blob/main/visualizations/plotly/plotly-line-chart.ipynb)
- [**Plotly Interactive Histogram Chart**](https://github.com/mljar/mercury-integrations/blob/main/visualizations/plotly/plotly-interactive-line-chart.ipynb)
