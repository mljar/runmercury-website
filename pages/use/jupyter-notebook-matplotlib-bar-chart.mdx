...
import mplonlyPng from "../../public/images/integrations/matplotlib/bar-chart/matplotlib-only.png";
import mplandnpPng from "../../public/images/integrations/matplotlib/bar-chart/matplotlib-numpy.png";
import mplandpdPng from "../../public/images/integrations/matplotlib/bar-chart/matplotlib-pandas.png";
...
<Screenshot src={mplonlyPng} alt="Only Matplotlib Bar Chart" />
...
<Screenshot src={mplandnpPng} alt="Matplotlib and Numpy Bar Chart" />
...
<Screenshot src={mplandpdPng} alt="Matplotlib and Pandas Bar Chart" />

## Interactive Bar Chart

Static charts are boring, what about creating an interactive bar chart? It's possible with `matplotlib` and `mercury` packages. You can modify data range with `mercury` widgets. In this example we used **Slider**:
...
Now, you cam turn your Jupyter Notebook into Web App without additional code changes! Here is a video which presents how it will look:
