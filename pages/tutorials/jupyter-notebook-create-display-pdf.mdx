---
<<<<<<< HEAD
ogTitle: Create and display PDF in Jupyter Notebook
description: How to create and display PDF in Jupyter Notebook using Python and Mercury's widgets. 
=======
...
>>>>>>> 3b9e3560e47e6eae99f1740433111591adc689dc
ogImage: tutorials
---
...
You will need following pakcages: 
```
reportlab
mercury
```
