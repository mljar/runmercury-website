...
Moreover, we will publish Python notebook as a web application thanks to the Mercury framework.
...
Please call `head()` functtion to display the first 20 samples from our data:
```python
df.head(20)
```
