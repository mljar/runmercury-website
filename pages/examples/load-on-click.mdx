---
ogTitle: Load large data and models with mouse click in Python
description: Load large files and models with mouse click in web app created from Jupyter Notebook with Mercury
ogImage: examples
---
