---
ogTitle: Upload and process files in Jupyter Notebook
description: You can upload files in Jupyter Notebook with Mercury widgets 
ogImage: examples
---
...
# File Upload in Jupyter Notebook
